...
import 'package:smart_agri/wether/api/weather_api.dart';
import 'package:smart_agri/wether/models/weather_forecast_hourly.dart';
...
class MainScreenModel extends ChangeNotifier {
  ...
  Future<void> setup() async {
    _forecastObject ??=
        await WeatherApi().fetchWeatherForecast(cityName: 'India');
    updateState();
  }
